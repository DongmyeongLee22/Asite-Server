...
operation::attendance-check[snippets='request-headers,request-fields,request-parameters,http-request,response-headers,response-fields,http-response,links']

=== 시간표 조회

`GET` 요청을 사용해서 학생별 시간표를 조회할 수 있다.

operation::query-timetable[snippets='request-headers,request-fields,request-parameters,http-request,response-headers,response-fields,http-response,links']

=== 시간표 삭제

`DELETE` 요청을 사용해서 시간표를 삭제할 수 있다.

operation::delete-timetable[snippets='request-headers,request-parameters,http-request,response-headers,http-response']
